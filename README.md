...
Este projeto tem finalidade do uso final com jenkins envolvendo novas tecnicas aprendidas no curso de formação em Teste de Software.
...
* Entendimento do funcionamento de Testes automatizados.
